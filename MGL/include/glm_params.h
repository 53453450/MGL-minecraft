...
typedef struct GLMParams_t {
    ...
    GLuint max_debug_message_length;
    GLuint max_debug_logged_messages;
    GLuint max_subroutines;
    GLuint max_subroutine_uniform_locations;
    ...
    GLuint min_program_texture_gather_offset;
    GLuint max_program_texture_gather_offset;
    GLuint max_shader_storage_block_size;
    GLuint max_samples;
    GLfloat min_fragment_interpolation_offset;
    GLfloat max_fragment_interpolation_offset;
    GLuint fragment_interpolation_offset_bits;
} GLMParams;
