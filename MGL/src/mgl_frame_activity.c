...
_Atomic uint64_t g_mglHashRecomputeTextureSinceSwap       = 0;
_Atomic uint64_t g_mglHashRecomputeVertexSinceSwap        = 0;
_Atomic uint64_t g_mglHashRecomputeRenderSinceSwap        = 0;
_Atomic uint64_t g_mglHashRecomputeUniformSinceSwap       = 0;
...
_Atomic uint64_t g_mglReplayErrorRedirectsSinceSwap       = 0;
