...
void mtlBindBuffer(GLMContext glm_ctx, Buffer *ptr) {
    [mglBridgeTarget(glm_ctx, __func__) bindMTLBuffer:ptr];
}

void mtlBindTexture(GLMContext glm_ctx, Texture *ptr) {
    [mglBridgeTarget(glm_ctx, __func__) bindMTLTexture:ptr];
}

void mtlBindProgram(GLMContext glm_ctx, Program *ptr) {
    [mglBridgeTarget(glm_ctx, __func__) bindMTLProgram:ptr];
}

void mtlDeleteMTLObj(GLMContext glm_ctx, void *obj) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDeleteMTLObj: glm_ctx buffer: obj];
}

#pragma mark - Sync

void mtlGetSync(GLMContext glm_ctx, Sync *sync) {
    [mglBridgeTarget(glm_ctx, __func__) mtlGetSync: glm_ctx sync: sync];
}

void mtlWaitForSync(GLMContext glm_ctx, Sync *sync) {
    [mglBridgeTarget(glm_ctx, __func__) mtlWaitForSync: glm_ctx sync: sync];
}

GLenum mtlGetSyncStatus(GLMContext glm_ctx, Sync *sync) {
    return [mglBridgeTarget(glm_ctx, __func__) mtlGetSyncStatus: glm_ctx sync: sync];
}

void mtlReleaseSync(GLMContext glm_ctx, Sync *sync) {
    [mglBridgeTarget(glm_ctx, __func__) mtlReleaseSync: glm_ctx sync: sync];
}
...
void mtlFlush(GLMContext glm_ctx, bool finish) {
    [mglBridgeTarget(glm_ctx, __func__) mtlFlush:glm_ctx finish:finish];
}
...
void mtlClearBuffer(GLMContext glm_ctx, GLuint type, GLbitfield mask) {
    [mglBridgeTarget(glm_ctx, __func__) mtlClearBuffer: glm_ctx type: type mask: mask];
}
...
void mtlInvalidateRenderPass(GLMContext glm_ctx) {
    [mglBridgeTarget(glm_ctx, __func__) mtlInvalidateRenderPass:glm_ctx];
}

#pragma mark - Buffer

void mtlBufferSubData(GLMContext glm_ctx, Buffer *buf, size_t offset, size_t size, const void *ptr) {
    [mglBridgeTarget(glm_ctx, __func__) mtlBufferSubData: glm_ctx buf: buf offset:offset size:size ptr:ptr];
}

void *mtlMapUnmapBuffer(GLMContext glm_ctx, Buffer *buf, size_t offset, size_t size, GLenum access, bool map) {
    return [mglBridgeTarget(glm_ctx, __func__) mtlMapUnmapBuffer: glm_ctx buf: buf offset: offset size: size access: access map: map];
}

void mtlFlushBufferRange(GLMContext glm_ctx, Buffer *buf, GLintptr offset, GLsizeiptr length) {
    [mglBridgeTarget(glm_ctx, __func__) mtlFlushMappedBufferRange: glm_ctx buf: buf offset: offset length: length];
}
...
void mtlReadDrawable(GLMContext glm_ctx, void *pixelBytes, GLuint bytesPerRow, GLuint bytesPerImage, GLint x, GLint y, GLsizei width, GLsizei height) {
    [mglBridgeTarget(glm_ctx, __func__) mtlReadDrawable:glm_ctx pixelBytes:pixelBytes bytesPerRow:(NSUInteger)bytesPerRow bytesPerImage:(NSUInteger)bytesPerImage fromRegion:MTLRegionMake2D((NSUInteger)x, (NSUInteger)y, (NSUInteger)width, (NSUInteger)height)];
}
...
void mtlReadIntegerPixels(GLMContext glm_ctx, void *pixelBytes, GLuint bytesPerRow, GLuint bytesPerImage, GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type) {
    [mglBridgeTarget(glm_ctx, __func__) mtlReadIntegerPixels:glm_ctx pixelBytes:pixelBytes bytesPerRow:(NSUInteger)bytesPerRow bytesPerImage:(NSUInteger)bytesPerImage fromRegion:MTLRegionMake2D((NSUInteger)x, (NSUInteger)y, (NSUInteger)width, (NSUInteger)height) format:format type:type];
}
...
void mtlReadDepthPixels(GLMContext glm_ctx, void *pixelBytes, GLuint bytesPerRow, GLuint bytesPerImage, GLint x, GLint y, GLsizei width, GLsizei height) {
    [mglBridgeTarget(glm_ctx, __func__) mtlReadDepthPixels: glm_ctx pixelBytes:pixelBytes bytesPerRow:(NSUInteger)bytesPerRow bytesPerImage:(NSUInteger)bytesPerImage fromRegion:MTLRegionMake2D((NSUInteger)x, (NSUInteger)y, (NSUInteger)width, (NSUInteger)height)];
}
...
void mtlGetTexImage(GLMContext glm_ctx, Texture *tex, void *pixelBytes, GLuint bytesPerRow, GLuint bytesPerImage, GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLuint level, GLuint slice) {
    [mglBridgeTarget(glm_ctx, __func__) mtlGetTexImage:glm_ctx tex:tex pixelBytes:pixelBytes bytesPerRow:(NSUInteger)bytesPerRow bytesPerImage:(NSUInteger)bytesPerImage fromRegion:MTLRegionMake2D((NSUInteger)x, (NSUInteger)y, (NSUInteger)width, (NSUInteger)height) format:format type:type mipmapLevel:(NSUInteger)level slice:(NSUInteger)slice];
}
...
void mtlCopyTexSubImage(GLMContext glm_ctx, Texture *tex, GLuint slice, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) {
    [mglBridgeTarget(glm_ctx, __func__) mtlCopyTexSubImage:glm_ctx tex:tex slice:(NSUInteger)slice mipmapLevel:(NSUInteger)level xoffset:(NSInteger)xoffset yoffset:(NSInteger)yoffset x:(NSInteger)x y:(NSInteger)y width:(NSUInteger)width height:(NSUInteger)height];
}

void mtlGenerateMipmaps(GLMContext glm_ctx, Texture *tex) {
    [mglBridgeTarget(glm_ctx, __func__) mtlGenerateMipmaps:glm_ctx forTexture:tex];
}
...
void mtlCopyImageSubData(GLMContext glm_ctx, Texture *srcTex, GLint srcLevel, GLint srcX, GLint srcY, GLint srcZ, Texture *dstTex, GLint dstLevel, GLint dstX, GLint dstY, GLint dstZ, GLsizei width, GLsizei height, GLsizei depth) {
    [mglBridgeTarget(glm_ctx, __func__) mtlCopyImageSubData:glm_ctx srcTexture:srcTex srcLevel:srcLevel srcX:srcX srcY:srcY srcZ:srcZ dstTexture:dstTex dstLevel:dstLevel dstX:dstX dstY:dstY dstZ:dstZ width:width height:height depth:depth];
}
...
void mtlTexSubImage(GLMContext glm_ctx, Texture *tex, Buffer *buf, size_t src_offset, size_t src_pitch, size_t src_image_size, size_t src_size, GLuint slice, GLuint level, size_t width, size_t height, size_t depth, size_t xoffset, size_t yoffset, size_t zoffset) {
    [mglBridgeTarget(glm_ctx, __func__) mtlTexSubImage:glm_ctx tex:tex buf:buf src_offset:src_offset src_pitch:src_pitch src_image_size:src_image_size src_size:src_size slice:slice level:level width:width height:height depth:depth xoffset:xoffset yoffset:yoffset zoffset:zoffset];
}
...
bool mtlTexSubImageBytes(GLMContext glm_ctx, Texture *tex, const void *bytes, size_t bytes_size, size_t src_offset, size_t src_pitch, size_t src_image_size, GLuint slice, GLuint level, size_t width, size_t height, size_t depth, size_t xoffset, size_t yoffset, size_t zoffset) {
    return [mglBridgeTarget(glm_ctx, __func__) mtlTexSubImageBytes:glm_ctx tex:tex bytes:bytes bytesSize:bytes_size src_offset:src_offset src_pitch:src_pitch src_image_size:src_image_size slice:slice level:level width:width height:height depth:depth xoffset:xoffset yoffset:yoffset zoffset:zoffset];
}

#pragma mark - Compute

void mtlDispatchCompute(GLMContext glm_ctx, GLuint num_groups_x, GLuint num_groups_y, GLuint num_groups_z) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDispatchCompute: glm_ctx groupsX:num_groups_x groupsY:num_groups_y groupsZ:num_groups_z];
}

void mtlDispatchComputeIndirect(GLMContext glm_ctx, GLintptr indirect) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDispatchComputeIndirect: glm_ctx indirect:indirect];
}

#pragma mark - Query

void mtlBeginTimerQuery(GLMContext glm_ctx) {
    [mglBridgeTarget(glm_ctx, __func__) mtlBeginTimerQuery: glm_ctx];
}

GLuint64 mtlEndTimerQuery(GLMContext glm_ctx) {
    return [mglBridgeTarget(glm_ctx, __func__) mtlEndTimerQuery: glm_ctx];
}

GLuint64 mtlGetGPUTimestamp(GLMContext glm_ctx) {
    return [mglBridgeTarget(glm_ctx, __func__) mtlGetGPUTimestamp: glm_ctx];
}

void mtlBeginSampleQuery(GLMContext glm_ctx) {
    [mglBridgeTarget(glm_ctx, __func__) mtlBeginSampleQuery: glm_ctx];
}

GLuint64 mtlEndSampleQuery(GLMContext glm_ctx) {
    return [mglBridgeTarget(glm_ctx, __func__) mtlEndSampleQuery: glm_ctx];
}
...
void mtlDrawElements(GLMContext glm_ctx, GLenum mode, GLsizei count, GLenum type, const void *indices) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawElements: glm_ctx mode: mode count: count type: type indices: indices];
}
...
void mtlDrawRangeElements(GLMContext glm_ctx, GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void *indices) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawRangeElements: glm_ctx mode: mode start: start end: end count: count type: type indices: indices];
}

void mtlDrawArraysInstanced(GLMContext glm_ctx, GLenum mode, GLint first, GLsizei count, GLsizei instancecount) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawArraysInstanced: glm_ctx mode: mode first: first count: count instancecount: instancecount];
}
...
void mtlDrawElementsInstanced(GLMContext glm_ctx, GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawElementsInstanced: glm_ctx mode: mode count: count type: type indices: indices instancecount: instancecount];
}
...
void mtlDrawElementsBaseVertex(GLMContext glm_ctx, GLenum mode, GLsizei count, GLenum type, const void *indices, GLint basevertex) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawElementsBaseVertex: glm_ctx mode: mode count: count type: type indices: indices basevertex: basevertex];
}
...
void mtlDrawRangeElementsBaseVertex(GLMContext glm_ctx, GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void *indices, GLint basevertex) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawRangeElementsBaseVertex:glm_ctx mode:mode start: start end: end count:count type: type indices: indices basevertex:basevertex];
}
...
void mtlDrawElementsInstancedBaseVertex(GLMContext glm_ctx, GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLint basevertex) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawElementsInstancedBaseVertex:glm_ctx mode:mode count:count type:type indices:indices instancecount:instancecount basevertex:basevertex];
}

void mtlDrawArraysIndirect(GLMContext glm_ctx, GLenum mode, const void *indirect) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawArraysIndirect:glm_ctx mode:mode indirect:indirect];
}

void mtlDrawElementsIndirect(GLMContext glm_ctx, GLenum mode, GLenum type, const void *indirect) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawElementsIndirect:glm_ctx mode:mode type:type indirect:indirect];
}
...
void mtlDrawArraysInstancedBaseInstance(GLMContext glm_ctx, GLenum mode, GLint first, GLsizei count, GLsizei instancecount, GLuint baseinstance) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawArraysInstancedBaseInstance:glm_ctx mode:mode first:first count:count instancecount:instancecount baseinstance:baseinstance];
}
...
void mtlDrawElementsInstancedBaseInstance(GLMContext glm_ctx, GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLuint baseinstance) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawElementsInstancedBaseInstance:glm_ctx mode:mode count:count type:type indices:indices instancecount:instancecount baseinstance:baseinstance];
}
...
void mtlDrawElementsInstancedBaseVertexBaseInstance(GLMContext glm_ctx, GLenum mode, GLsizei count, GLenum type, const void *indices, GLsizei instancecount, GLint basevertex, GLuint baseinstance) {
    [mglBridgeTarget(glm_ctx, __func__) mtlDrawElementsInstancedBaseVertexBaseInstance:glm_ctx mode:mode count:count type:type indices:indices instancecount:instancecount basevertex:basevertex baseinstance:baseinstance];
}

void mtlMultiDrawArrays(GLMContext glm_ctx, GLenum mode, const GLint *first, const GLsizei *count, GLsizei drawcount) {
    [mglBridgeTarget(glm_ctx, __func__) mtlMultiDrawArrays:glm_ctx mode:mode first:first count:count drawcount:drawcount];
}
...
void mtlMultiDrawElements(GLMContext glm_ctx, GLenum mode, const GLsizei *count, GLenum type, const void *const*indices, GLsizei drawcount) {
    [mglBridgeTarget(glm_ctx, __func__) mtlMultiDrawElements: glm_ctx mode: mode count: count type: type indices: indices drawcount: drawcount];
}
...
void mtlMultiDrawElementsBaseVertex(GLMContext glm_ctx, GLenum mode, const GLsizei *count, GLenum type, const void *const*indices, GLsizei drawcount, const GLint *basevertex) {
    [mglBridgeTarget(glm_ctx, __func__) mtlMultiDrawElementsBaseVertex: glm_ctx mode: mode count: count type: type indices: indices drawcount: drawcount basevertex:basevertex];
}

void mtlMultiDrawArraysIndirect(GLMContext glm_ctx, GLenum mode, const void *indirect, GLsizei drawcount, GLsizei stride) {
    [mglBridgeTarget(glm_ctx, __func__) mtlMultiDrawArraysIndirect:glm_ctx mode:mode indirect:indirect drawcount:drawcount stride:stride];
}
...
void mtlMultiDrawElementsIndirect(GLMContext glm_ctx, GLenum mode, GLenum type, const void *indirect, GLsizei drawcount, GLsizei stride) {
    [mglBridgeTarget(glm_ctx, __func__) mtlMultiDrawElementsIndirect:glm_ctx mode:mode type:type indirect:indirect drawcount:drawcount stride:stride];
}
