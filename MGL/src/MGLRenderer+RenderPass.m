...
- (bool)syncPipelineStateWithDeferredBufferMap:(bool)deferredBufferMapForPipelineBuild
{
            ...
            if (!pipelineResolvedFromCache) {
                ...
                return mglRenderPassBuildPipelineStateOnCacheMiss(
                    (__bridge void *)self, &psoState,
                    (__bridge void *)psoVertexFunction,
                    (__bridge void *)psoFragmentFunction, storeKeyWords,
                    pipelineSig, vertexSig, builtColor0Format, builtDepthFormat,
